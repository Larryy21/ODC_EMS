...
<div class="p-2 md:p-4 flex-1 overflow-hidden flex flex-col min-h-screen">
    <div class="flex flex-col md:flex-row gap-4 flex-1 overflow-y-auto">
        <!-- Employee Details Card (Left Side) -->
        <div class="w-full md:w-2/6 shadow-xl rounded-md p-3">
            <div class="flex flex-col md:flex-row items-center gap-3">  
                <img src="{{ asset('images/austria.jpg') }}" alt="Employee Photo" class="rounded-full w-24 h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 border-2 border-black object-cover max-w-full">
...
<table class="w-full text-xs text-gray-900 table-auto break-words">
    <tbody>
        ...
        <tr><td class="text-gray-500 font-medium pr-4">Email:</td><td class="text-blue-600 underline cursor-pointer font-semibold"><a href="{{ url('employee/' . $employeeId) }}" class="text-blue-600 underline cursor-pointer font-semibold">{{ $email }}</a></td></tr>
    </tbody>
</table>
    ...
    <div class="w-full md:w-3/4 bg-white shadow-lg rounded-md p-4 flex flex-col relative">
        <div class="border border-gray-300 rounded-md overflow-hidden">
            ...
            <div class="text-white px-3 py-2 flex items-center text-xs font-bold" 
                ...
                <span class="text-center hidden sm:inline-block" style="width: 110px;">STATUS</span>
                <span class="text-left px-3 hidden sm:inline-block" style="width: 110px;">DEADLINE</span>
            </div>
            ...
            <div class="divide-y divide-gray-300 bg-white h-60 overflow-y-auto min-h-0">
                ...
                <div class="flex flex-col sm:flex-row items-center px-3 py-3 text-xs">
                    <input type="checkbox" class="w-4 h-4 border border-gray-400 rounded mr-3">
                    
                    <!-- Task Name -->
                    <span class="flex-1 px-3 text-center sm:text-left">{{ $task['name'] }}</span>
                
                    <!-- Centered Status -->
                    <div class="flex justify-center items-center w-20 hidden sm:flex"> 
                    ...
                    <!-- Deadline -->
                    <span class="w-28 text-center px-2 hidden sm:inline-block">{{ $task['deadline'] }}</span>
                </div>
                @endforeach
            </div>
        </div>
...
<div class="custom-gradient text-white p-6 rounded-b-lg flex items-center mt-4">
    <p class="text-sm">This is the bottom container content.</p>
</div>
</div>
@livewireScripts
{{-- </body> --}}